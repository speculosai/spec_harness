 ...
 * first bar is always full width and the rest are read against it.
 */
...
export function WeekPanel({ lines, stops, weekStart, today }: WeekPanelProps) {
  ...
  const worst = machineTotals(shown, lines)[0];
