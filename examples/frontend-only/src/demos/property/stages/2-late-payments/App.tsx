/**
 * The attention board, with the late-payment panel underneath it.
 *
 * The board answers "what needs a look today"; the panel answers the first question
 * anyone asks after seeing it - how far behind, and which building is carrying it.
 *
 * The page still owns nothing but the reading. The rules and the money are worked out
 * in `lib/attention.ts`, and the drawing is in `components/`.
 */
